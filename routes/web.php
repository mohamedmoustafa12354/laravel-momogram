...
Route::post('/p/{post:slug}/comment', [App\Http\Controllers\CommentController::class, 'store'])->name('store_comment')->middleware('auth');
Route::get('/p/{post:slug}/edit', [PostController::class, 'edit'])->name('edit_post')->middleware('auth');
Route::post('/p/{post:slug}/update', [PostController::class, 'update'])->name('update_post')->middleware('auth');
